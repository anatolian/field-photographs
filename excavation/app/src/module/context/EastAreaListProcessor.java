...
public class EastAreaListProcessor extends HttpOperation implements
		HttpProcessor {
	String ip_address;
public EastAreaListProcessor(String ip_address) {
	...
	public HttpObject getHttp(Map<Request, String> mapParams) {
		...
		object.setUrl(generateUrlWithParams(HttpRequester.GET_AREA,
	...
	public List<SimpleData> parseList(HttpObject object) {
		...
		try {
			...
			JSONObject resData = resObj.getJSONObject(STANDARD.responseData
					.name());
		//	Log.e("EastrArea",object.getResponseString());
